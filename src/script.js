...
const wallColorTexture = textureLoader.load('../wall/brick_wall_005_1k/brick_wall_005_diff_1k.webp')
const wallArmTexture = textureLoader.load('../wall/brick_wall_005_1k/brick_wall_005_arm_1k.webp')
const wallNormalTexture = textureLoader.load('../wall/brick_wall_005_1k/brick_wall_005_nor_gl_1k.webp')
...
// roofColorTexture.rotation.x = 20
...
const doorAmnientOcclusionTexture = textureLoader.load('../door/ambientOcclusion.webp');
...
const door = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        aoMap: doorAmnientOcclusionTexture,
...
bush2.position.set(1.6, 0.1, 2.2)
...
bush4.position.set(-1.2, 0.05, 2.4)
...
const ghost3 = new THREE.PointLight('#ff0000', 1)
...
controls.maxPolarAngle = 1.56; // Limit vertical rotation
...
const tick = () =>
{
    ...
    ghost3.position.x = Math.cos(ghost3Angle) * 5.8
    ghost3.position.z = Math.sin(ghost3Angle) * 5.8
